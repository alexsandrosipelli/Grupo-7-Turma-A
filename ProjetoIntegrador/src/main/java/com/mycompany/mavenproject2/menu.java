...
"O Mochileiro estava na estrada já a um bom tempo, sem comer ou descansar. Olhando colina abaixo avistou uma pequena vila onde vivia uma ninfa do lago que fazia a natureza crescer saudável e forte e, "
      ...
      System.out.println(questao2);  
        ...
        int cantil1=0;
          ...
          do
       {
           if (cantil1>=1){ System.out.println("- O triplo de um número adicionado com 45 corresponde a seu dobro adicionado a 155. Determine esse numero;\n"); }
          ...
          do
       {
          ...
          if (cantil7>=1){ System.out.println("Andarilho - O quintuplo de um número adicionado com 65 corresponde a seu triplo adicionado 195. Module a questão.\n"); }
          ...
          do
       {
          ...
          if (cantil2>=1){ System.out.println("Andarilho - Resolva o resultado da questão anterior: 5X+65=3X195."); }
        ...
        do {
            Collections.shuffle(alternativas4);
             if (cantil3>=1){ System.out.println("- 6 unidades somadas ao dobro de um número é igual a 82. Module a questão."); }
              Collections.shuffle(alternativas4);
        ...
        if (acertou3)
          ...
          {
              System.out.println("Nao vou devolver suas coisas... " +nome+ " Sem seus pertences nao conseguirar seguir "+ perdeu);System.exit(0);
          }
        ...
        do {
            Collections.shuffle(alternativas5);
             if (cantil4>=1){ System.out.println("Esquilo - Não acabou aqui, agora resolva a questão. Qual o valor de N na expressão: 6+2N=82."); }
              Collections.shuffle(alternativas5);
        ...
        do {
            Collections.shuffle(alternativas6);
             if (cantil5>=1){ System.out.println("Esquilo - Vou dificultar um pouco mais. O quadrado de um número menos o seu triplo é igual a 40. Qual é este número ? "); }
              Collections.shuffle(alternativas6);
        ...
        do {
            Collections.shuffle(alternativas7);
             if (cantil6>=1){ System.out.println("Esquilo - E para encerrar resolva o resultado da questão anterior: X²-3X=40 "); }
              Collections.shuffle(alternativas7);
        ...
        switch(resposta5){
         ...
         if (acertou6)
          ...
          {
              System.out.println("Esquilo - Você errou, nao irei devolve-lo" + perdeu);System.exit(0);
          }
