...
//testando em sala junto com o grupo
    ...
    "O Mochileiro estava na estrada já a um bom tempo, sem comer ou descansar. Olhando colina abaixo avistou uma pequena vila onde vivia uma ninfa do lago que fazia a natureza crescer saudável e forte e, "
        ...
        public static void créditos(){ // aprensentando creditos
            ...
            System.out.println("JOGO CONSTRUÍDO COM O INTUITO DE AJUDAR ALUNOS COM DIFICULDADES EM MODULAÇÃO NA MATÉRIA DE MATEMÁTICA, FOI UTILIZANDO AS AULAS DO PROFESSOR EDUARDO TAKEO NO CURSO DE ANALISE E DESENVOLVIMENTO DE SISTEMAS,  DURANTE O PRIMEIRO SEMESTRE DE 2022 COM FIM DE SEMESTRE EM DEZEMBRO.");
